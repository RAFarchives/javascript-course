...
// console.log(RafaelImproved.calcAge()); 
...
const allClassMessages = document.getElementsByClassName("message");
console.log(allClassMessages);
console.log(allClassMessages[0] === message);
console.log(allButtons[1] === button);
const allClassGuesses = document.getElementsByClassName("guess");
console.log(allClassGuesses);
console.log(allClassGuesses[0] === input);
console.log(allParagraphs[2] === heading);
const allDivs = document.getElementsByTagName("div");
console.log(allDivs);
console.log(allDivs[0] === document.querySelector("div"));
console.log(allDivs[1] === document.querySelectorAll("div")[1]);
const allDivsQuery = document.querySelectorAll("div");
console.log(allDivsQuery);
